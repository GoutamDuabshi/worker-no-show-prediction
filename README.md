...
ML-based model to predict gig worker no-shows using travel distance, pay scale, and past attendance

Worker No-Show Prediction (DailyGo) (Nammura tech force pvt ltd)
